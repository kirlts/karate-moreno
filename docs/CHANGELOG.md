...
- Error 404 en carga de assets al usar dominio personalizado en GitHub Pages.
- Refinado de `aria-labels` en el componente de información para mayor precisión.
